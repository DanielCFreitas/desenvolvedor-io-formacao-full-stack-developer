...
namespace AppSemTemplate.Controllers
{
    ...
    public class ProdutosController : Controller
    {
        ...
        public async Task<IActionResult> CriarProduto([Bind("Id,Nome,ImagemUpload,Valor")] Produto produto)
        {
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,ImagemUpload,Valor")] Produto produto)
        {
            ...
            var produtoDb = await _context.Produtos.AsNoTracking().FirstOrDefaultAsync(produto => produto.Id == id);
